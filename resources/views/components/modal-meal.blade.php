    ...
    <div class=" relative w-full h-full max-w-md md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="{{ route('meals.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="relative">
                                ...
                                <div class="text-sm text-gray-600 dark:text-gray-400">
                                    <label class="relative bg-transparent rounded-md font-medium text-blue-600 dark:text-blue-500">
                                        <p class="text-gray-500 dark:text-white space-y-1">
                                            <span class="text-blue-600 dark:text-blue-500">Upload a file</span> or drag
                                            and drop
